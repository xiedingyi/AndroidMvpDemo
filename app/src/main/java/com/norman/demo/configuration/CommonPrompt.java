package com.norman.demo.configuration;

import android.annotation.SuppressLint;

import com.norman.demo.utils.SDCardUtils;
...
public class CommonPrompt {
    public static final String ERROR = "数据加载错误，请稍候再试!";
     ...
     * 文件根目录
     */
    public static final String STORAGEPATH = SDCardUtils.getSDCardPath() + "/" + APPNAME + "/";
